            ...
            <ul className="list-disc ml-4">
                ...
                <li>Chirps can be created up to 500 characters long, and attached with an optional image, which are stored in Azure Blob Storage</li>
                    <ul className="list-disc ml-6">
                        ...
                        <li>Rechirping: Chirps can be rechirped, which will show on profile page feeds and on the Following feed</li>
                        <li>Following: Users can follow other users to see their posts on their Following feed on the home page</li>
                        <li>Pinning: Users can pin one chirp or rechirp at the top of their profile feed</li>
                    </ul>
                <li>Chirps can be opened into a separate page where it shows</li>
                    <ul className="list-disc ml-6">
                        ...
                        <li>Commenting: Chirps can be commented on, where each comment is itself a post which makes chirps, comments (and comments on comments) a recursive structure. Comments can not have images, but also have no character limit</li>
                    </ul>
            </ul>
